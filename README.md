...
- `joinLink` приходит готовым из exporter-а и должен подтягиваться только из `Squadbrowser API` по exact server name;
...
- возвращать `joinLink: null`, если `Squadbrowser API` не вернул валидный lobby link.
